# 📝 Content Reference - All Polish Copy

This document lists all the Polish text content used on the website, extracted from the brief and organized by section.
...
Dojazd do klienta lub odbiór sprzętu na terenie Żor / Rybnika i okolic.
Szybko, rzetelnie i w rozsądnej cenie.
```
...
4. Reinstalacja systemu Windows, macOS, Linux
5. Odzyskiwanie danych z uszkodzonych dysków
6. Usuwanie wirusów i malware
7. Optymalizacja i przyspieszanie systemu
8. Przeniesienie systemu na SSD (klonowanie)
9. Składanie i modernizacja komputerów PC
...
- Wymiana matrycy w laptopie – **100–150 zł + koszt matrycy**
- Wymiana gniazda zasilania – **150–250 zł**
- Wymiana chłodzenia / wentylatora – **80–150 zł**
...
1. **All headings, CTAs, and body text** are in Polish
2. **Exact strings from brief** are preserved where specified
3. **Legal disclaimers** use exact wording
4. **Pricing note** uses exact wording as required
5. **All content** is stored in modular files for easy editing
6. **No hard-coded contact info** - all from environment variables

---

**This document serves as a complete reference for all Polish copy used in the project.**
